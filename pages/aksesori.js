...
export default function aksesori() {
    ...
    useEffect(() => {
        (async function fetchApi() {
            let response = await fetch("https://api.tbdamai.net/frontend/product/aksesori")
        ...
        (async function fetchIp() {
            ...
            const data = {
                ...
                event_source_url: "https://tbdamai.net/aksesori/",
                user_data: {
    ...
    return (
        <div className="container mx-auto p-5">
            <Head>
                <meta
                    name="description"
                    content="berbagai macam model aksesori untuk pagar dan railing"
                />
                <meta
                    name="keywords"
                    content="aksesori, daun, bunga, pagar, railing"
                />
                <title>TBdamai | Aksesori</title>
            </Head>
            <div className="text-white font-semibold text-lg bg-blue-500 text-white rounded-2xl w-32 text-center mt-5 mb-5">Aksesori</div>
