    ...
    return (        
        <>            
            {data.map(dt => <div key={dt.id} className="grid grid-cols-3 gap-2 shadow-lg p-2 rounded-lg ">
                ...
                <div className=""></div>
                <div className="col-span-3 bg-neptune text-white rounded-2xl px-2">Berat: {dt.prod_weight} {dt.prod_unit_weight}</div>
                {/* <div className=""></div> */}
                <div className="col-span-3 bg-neptune text-white rounded-2xl px-2">Ukuran: {dt.prod_height} x {dt.prod_unit_size}</div>
